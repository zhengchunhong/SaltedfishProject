...
//¼àÌýÆ÷
public class WebTestListenerFreemarker extends TestListenerAdapter {
	FreemarkerReport ft=new FreemarkerReport();
	
	public WebTestListenerFreemarker() {
		super();
	}
			...
			if(ReadProperties.getPropertyValue("enable_email").equals("true"))
			{
				...
				try {
					if(this.getFailedTests()!=null&&this.getFailedTests().size()>0)
					{
						...
						mail.sendMail(emailTitle, emailContent);
